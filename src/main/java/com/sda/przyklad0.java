...
public class przyklad0 {
  ...
  public static void main(String[] args) {
    ...
    User user1 = new User("Boris", "Johnson", "brexit", "bj@uk.com", address2, LocalDate.of(1970, Month.FEBRUARY,20));
    User user2 = new User("Jan", "Kowalski", "test", "jk@wp.pl",address1, LocalDate.now());
    User user3 = new User("Tony", "Blair", "test", "tb@uk.com", address2, LocalDate.of(1960, Month.AUGUST, 5));
    User user4 = new User("Adam", "Nowak", "test2", "ad@wp.pl", address1, LocalDate.of(1995, Month.JANUARY, 16));

    Product product = new Product("Kanapka", BigDecimal.valueOf(10), "Z Dzemem");
    Product product2 = new Product("Komputer", BigDecimal.valueOf(120), "Duzy");
    Product product3 = new Product("Bulka", BigDecimal.valueOf(5), "Z Maslem");
    Product product4 = new Product("kurs", BigDecimal.valueOf(10000), "SDA");
    ...
    products1.add(product);
    order2.setProducts(products3);
    Set<Product> products4 = new HashSet<>();
    products1.add(product3);
    order2.setProducts(products4);
